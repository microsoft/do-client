...
const std::chrono::seconds g_docsIdleTimeoutSeconds = 60s;
...
const std::string g_tmpFileName = "/tmp/dosdkcpp_testfile.txt";
const std::string g_tmpFileName2 = "/tmp/dosdkcpp_testfile2.txt";
const std::string g_tmpFileName3 = "/tmp/dosdkcpp_testfile3.txt";
