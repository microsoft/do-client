...
public:
    ...
    /* User Note:
    These constructors will throw on failure, unless DO_DISABLE_EXCEPTIONS is toggled, in which case init_code() must be called to check if initialization failed
    */
