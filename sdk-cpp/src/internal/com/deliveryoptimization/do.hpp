...
{
public:
    IFACEMETHOD(Start)(const DO_DOWNLOAD_RANGES_INFO *ranges) = 0;
    IFACEMETHOD(Pause)() = 0;
    IFACEMETHOD(Abort)() = 0;
    ...
    IFACEMETHOD(SetProperty)(DODownloadProperty propId, const VARIANT* propVal) = 0;
};
...
public:
    ...
    IFACEMETHOD(EnumDownloads)(const DO_DOWNLOAD_ENUM_CATEGORY* category, IEnumUnknown** ppEnum) = 0;
};
