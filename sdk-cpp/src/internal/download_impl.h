...
{
public:
    CDownloadImpl(const std::string& uri, const std::string& downloadFilePath) noexcept;
    ...
    //TODO(jimson): Implement Get/Set for the rest interface
...
private:
    int32_t _Initialize(const std::string& uri, const std::string& downloadFilePath) noexcept;
