...
#ifndef _DELIVERY_OPTIMIZATION_DO_URI_BUILDER_H
#define _DELIVERY_OPTIMIZATION_DO_URI_BUILDER_H

#include <string>
#include "do_cpprest_base_uri.h"
...
#endif // _DELIVERY_OPTIMIZATION_DO_URI_BUILDER_H
